...
use logion_runtime::{AccountId, AuraId, Signature, EXISTENTIAL_DEPOSIT, Balance, LGNT, WASM_BINARY};
...
pub fn development_config() -> Result<ChainSpec, String> {
	Ok(ChainSpec::builder(
		logion_runtime::WASM_BINARY.ok_or_else(|| "Development wasm not available".to_string())?,
		Extensions {
...
pub fn chimay_config() -> Result<ChainSpec, String> {
	Ok(ChainSpec::builder(
	...
	.with_protocol_id("chimay")
	.with_properties(default_properties("CHY"))
	.build())
}
